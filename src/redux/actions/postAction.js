import { postAPITest } from "../../utils/fetchAPI";
...
//       const res = await postAPI("posts", { content, images: media }, auth.token);
...
export const createPostTest =
  ...
  async (dispatch) => {
    let media = [];
    try {
      media = "https://res.cloudinary.com/ductinh/image/upload/v1676095073/instagram/avatar_cugq40_q61cra.png"
